...
namespace Files
{
    class Files
    {
        ...
        {
            Dictionary<string, Dictionary<string, BigInteger>> storage = new Dictionary<string, Dictionary<string, BigInteger>>();
            ...
            for (int i = 0; i < n; i++)
            {
                ...
                BigInteger fileSize = BigInteger.Parse(fileData[1]);
                ...
                {
                    storage.Add(root, new Dictionary<string, BigInteger> { { fileName, fileSize } });
                }
            }
